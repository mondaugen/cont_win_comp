...
\def\papertitle{Templates for DAFx-17, Edinburgh, UK}
...
%{\href{http://www.ntnu.edu/dafx15}{Department of Music, Norwegian} \\ University of Science and Technology \\Trondheim, Norway \\ {\tt \href{mailto:dafx15@iet.ntnu.edu}{dafx15@iet.ntnu.edu}}
%}
...
{\paperauthorC \,\sthanks{Illustrious contributor}}
{\href{http://www.ntnu.edu/dafx15}{Department of Music,} \\ Norwegian University of Science and Technology (NTNU) \\Trondheim, Norway \\ {\tt \href{mailto:dafx15@iet.ntnu.edu}{dafx15@iet.ntnu.edu}}
}
...
\begin{abstract}
This is the template file for the proceedings of the 20$^{\text{th}}$ International Conference on Digital Audio Effects (DAFx-17).
...
\href{http://dafx17.eca.ed.ac.uk/}{http://dafx17.eca.ed.ac.uk/}.
\end{abstract}
...
\bibliography{DAFx17_tmpl} % requires file DAFx17_tmpl.bib
