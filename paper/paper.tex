...
%Theoretically, the estimation of the parameters of a polynomial
%phase function of arbitrary order make it possible to approximate any analytical
%phase function to desired precision.
%
...
\begin{figure*}[ht]
    \centerline{\includegraphics[width=5in]{{ddm_snr_win_comp}.eps}}
...
\begin{figure*}[ht]
    \centerline{\includegraphics[width=5in]{{comp_offset_chirp_est_err}.eps}}
