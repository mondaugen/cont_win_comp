...
The family of parametric windows whose construction is based on functions
proposed by Slepian et al. maximimzing the energy in a given bandwidth can be
...
straight-forward as differentiation of the sum-of-cosine windows. Furthermore,
the windows do not generally have end-points equal to 0. Motivated by this, and
the desire to approximate aribtrary windows using sums of cosines leads us to
the design of high-performance windows (e.g., with extremely low side-lobes) by
approximation.
